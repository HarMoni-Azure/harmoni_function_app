...
HARMoni는 Wear OS 기반 웨어러블 디바이스에서 수집되는 가속도·자이로 센서 데이터를 활용하여  
산업 현장의 낙상 사고를 **실시간으로 감지·분석**하는 Azure Databricks 기반 IoT 데이터 분석 플랫폼이다.
...
## 8. Data Architecture (Medallion Architecture)
